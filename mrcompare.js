...
module.exports = async (client) => {
  ...
  fs.readdirSync(path.join(process.cwd(), commandPath))
  ...
  client.on("interactionCreate", async (interaction) => {
    if (interaction.type === InteractionType.ApplicationCommand) {
      try {
        ...
        console.error(error);
        const embed = new EmbedBuilder().setTitle("An error occured while executing that command.").setColor(Colors.Red);
